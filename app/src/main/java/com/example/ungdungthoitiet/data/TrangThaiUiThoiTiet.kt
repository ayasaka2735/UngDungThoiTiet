...
data class TrangThaiUiThoiTiet(
    ...
    val danhSachGoiYTimKiem: List<DuLieuThoiTiet> = emptyList(), // Danh sách bộ lọc gợi ý khi nhấn chữ
    val chuoiTimKiemHienTai: String = "",   // Chuỗi chữ người dùng gõ vào ô nhập
    val thongBaoLoiNhapLieu: String? = null // Chuỗi văn bản báo lỗi đầu vào (Validation)
)